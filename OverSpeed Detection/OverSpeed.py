...
cv2.setMouseCallback('Cars', RGB)

cap=cv2.VideoCapture('C:\Traffic Management for Ideathon\OverSpeed Detection\ veh2.mp4')


my_file = open("C:\Traffic Management for Ideathon\OverSpeed Detection\coco.txt", "r")
data = my_file.read()
...
#        print(row)
    ...
    cv2.putText(frame,('OverSpeed Count-')+str(OverSpeedCounter),(60,180),cv2.FONT_HERSHEY_COMPLEX,0.8,(0,255,255),2)
    Flag = 0;


    cv2.imshow("Cars", frame)

    #this means, if ESC key is pressed, the window closes.
